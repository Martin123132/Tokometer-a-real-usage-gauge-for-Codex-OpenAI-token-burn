# Tokometer-a-real-usage-gauge-for-Codex-OpenAI-token-burn Notice

Tokometer-a-real-usage-gauge-for-Codex-OpenAI-token-burn is source-available software, not open-source software.

Required Notice: Copyright (c) 2026 TWO HANDS NETWORK LTD.

Tokometer-a-real-usage-gauge-for-Codex-OpenAI-token-burn is licensed under the PolyForm Noncommercial License 1.0.0. Personal, hobby, research, educational, public-interest, and other non-commercial uses are permitted under that license.

Commercial use requires a separate written license from the licensor. Commercial use includes, without limitation:

- bundling Tokometer-a-real-usage-gauge-for-Codex-OpenAI-token-burn or derived code into a paid product;
